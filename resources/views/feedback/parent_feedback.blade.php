...
<head>
    ...
    <title>HomeSayar|Parent Feedback</title>
        ...
        <div class="mx-auto max-w-3xl">
            <div class="mb-6 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">Parent Feedback (မိဘ မှတ်ချက်)</h2>
            ...
            <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xl">
                <div class="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-4">
                    <h3 class="text-xl font-bold text-white">Parent Feedback Form</h3>
                </div>

                <div class="space-y-6 p-6">
                    <div class="rounded-xl bg-gray-50 p-4">
                        <label class="mb-3 block text-sm font-semibold text-gray-700">ဆရာအမည် (Teacher Name)</label>
                        <select class="w-full rounded-lg border border-green-300 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-green-400 focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500">
                            <option value="">ဆရာရွေးပါ</option>
                            <option value="1">ဦးမင်းသူ</option>
                            <option value="2">ဒေါ်သီရိမောင်</option>
                            <option value="3">ဦးကျော်ဇော်</option>
                        </select>
                    </div>
                    ...
                    <div class="rounded-xl bg-gray-50 p-4">
                        <label class="mb-3 block text-sm font-semibold text-gray-700">သင်ကြားမှု အရည်အသွေး (Teaching Quality)</label>
                    ...
                    <div class="rounded-xl bg-gray-50 p-4">
                        ...
                        <textarea rows="3" placeholder="ဆရာ၏ ကောင်းသောအချက်များ ဖော်ပြပါ..." class="w-full resize-none rounded-lg border border-green-300 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-green-400 focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500"></textarea>
                    </div>

                    <div class="rounded-xl bg-gray-50 p-4">
                        <label class="mb-3 block text-sm font-semibold text-gray-700">တိုးတက်ရန်လိုအပ်သောအချက်များ (Areas for Improvement)</label>
                        <textarea rows="3" placeholder="ဆရာ တိုးတက်ရန် လိုအပ်သောအချက်များ ဖော်ပြပါ..." class="w-full resize-none rounded-lg border border-green-300 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-green-400 focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500"></textarea>
                    </div>

                    <div class="rounded-xl bg-gray-50 p-4">
                        <label class="mb-3 block text-sm font-semibold text-gray-700">ကျောင်းသား တိုးတက်မှု (Student Progress)</label>
                        <textarea rows="3" placeholder="ကျောင်းသား၏ �学习的进步 ဖော်ပြပါ..." class="w-full resize-none rounded-lg border border-green-300 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-green-400 focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500"></textarea>
                    </div>

                    <div class="rounded-xl bg-gray-50 p-4">
                        <label class="mb-3 block text-sm font-semibold text-gray-700">အကြံပြုချက်များ (Recommendations)</label>
                        <textarea rows="3" placeholder="ဆရာနှင့် ပလက်ဖောင်းအား အကြံပြုချက်များ ပေးပါ..." class="w-full resize-none rounded-lg border border-green-300 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-green-400 focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500"></textarea>
                    </div>
