...
<head>
    ...
    <title>HomeSayar|Admin Approved</title>
    ...
    <div class="p-6 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 min-h-screen">
        <div class="max-w-7xl mx-auto">
            <div class="flex items-center mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Teacher Verification Panel (ရန်ကုန်တိုင်း)</h2>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">ဆရာအမည်</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">ဘာသာရပ် / မြို့နယ်</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">ထောက်ခံစာများ</th>
                        ...
                        <tr class="hover:bg-green-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <div class="flex space-x-2">
                                    <a href="#" class="text-green-600 hover:text-green-900 underline">NRIC.jpg</a>
                                    <a href="#" class="text-green-600 hover:text-green-900 underline">Degree.pdf</a>
                                    <a href="#" class="text-green-600 hover:text-green-900 underline">Certificate.pdf</a>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                ...
                                <button wire:click="approve(1)" class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg">
                                    Approve
                                </button>
                                <button wire:click="reject(1)" class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-xs font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg">
                                    Reject
                                </button>
                            </td>
                        </tr>
