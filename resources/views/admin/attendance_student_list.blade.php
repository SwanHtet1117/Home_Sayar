...
<head>
    ...
    <title>HomeSayar|Attendance Student List</title>
    ...
    <div class="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Attendance Student List</h2>
                    <p class="text-sm text-gray-500">Admin can review student attendance records</p>
                </div>
            ...
            <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
                <div class="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-4">
                    <h3 class="text-xl font-bold text-white">Student Attendance Records</h3>
                </div>
                <div class="p-6">
                    <div class="mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                        <div class="text-sm text-gray-500">Showing current class attendance</div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Roll No.</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr class="hover:bg-green-50">
                                    <td class="px-4 py-4 font-medium text-gray-900">Aye Chan</td>
                                    ...
                                    <td class="px-4 py-4 text-sm text-gray-500">Attended full class</td>
                                </tr>
                                <tr class="hover:bg-green-50">
                                    <td class="px-4 py-4 font-medium text-gray-900">Khin Aye</td>
                                    ...
                                    <td class="px-4 py-4 text-sm text-gray-500">Arrived 10 mins late</td>
                                </tr>
                                <tr class="hover:bg-green-50">
                                    <td class="px-4 py-4 font-medium text-gray-900">Moe Thant</td>
                                    ...
                                    <td class="px-4 py-4 text-sm text-gray-500">Not present</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
