    ...
    <div class="mx-auto flex max-w-7xl flex-wrap items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap items-center gap-2 text-bold text-gray-900">
            ...
            @else
                ...
                <div class="group relative">
                    <button type="button" class="relative flex items-center rounded-full px-3 py-1 transition hover:bg-green-100 hover:text-green-700 focus:outline-none" onclick="this.nextElementSibling.classList.toggle('hidden'); positionDropdown(this, this.nextElementSibling)">
                    ...
                    <div class="fixed z-50 mt-1 hidden min-w-[320px] rounded-2xl border border-green-200 bg-white p-1 shadow-xl group-hover:block group-focus-within:block">
                        ...
                        <div class="border-t border-gray-100 px-4 py-2">
                            <a href="#" class="block text-center text-sm font-medium text-green-600 hover:text-green-800">View All Notifications</a>
                        </div>
                    </div>
                </div>
                <!-- account dropdown -->
